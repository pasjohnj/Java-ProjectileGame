...
//*******************************************************************************************\\
public class GameBoardLogic implements Serializable{
	...
	private void addBuildings(){ //loop to set up the coordinates that will generate the virtual game board and GUI game board
	...
	private ArrayList<ObjectWrapper> addWindows(int startingX, int startingY){
	...
	private int getPlayerCenterPointY(int buildingStartY, int playerHeight){
